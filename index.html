...
<marquee  width="100%" direction="right" ><h1><font face="algerian"color="yellow"size="25"><b>
ONLINE EXAMINATION SYSTEM</b></font></h1>
</marquee>
<?php
include("header.php");
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="29%" bgcolor=""><div align="center" class="style1">User Login </div></td>
  </tr>
  <tr>
    <td height="296" valign="top"><div align="center">
        <h1 class="style8">Wel come to Online Exam</h1>
...
<p align="left" class="style5">&nbsp;</p>
    ...
    <td valign="top"><form name="form1" method="post" action="">
      <table width="200" border="0">
        <tr>
          <td bgcolor="black"><span class="style2">Login ID </span></td>
          <td><input name="loginid" type="text" id="loginid2"></td>
        </tr>
        <tr>
          <td bgcolor="black"><span class="style2">Password</span></td>
        ...
        <tr>
          <td colspan="2" bgcolor=""><div align="center"><span class="style4">New User ? <a href="signup.php">Signup Free</a></span></div></td>
          </tr>
      </table>
      <div align="center">
        <p class="style5">      </p>
